...
const routes: Routes = [
  ...
  {path:"corporate/about",component: AboutComponent},
  {path:"corporate/history",component: HistoryComponent},
  {path:"corporate/catalog",component: CatalogComponent},
  {path:"corporate/export",component: ExportComponent},
  {path:"corporate/about-all",component: AboutAlltechComponent},
  {path:"corporate/dealership",component: DealershipComponent},
